                      ...
                      gpc_polygon *result)
{
  ...
  int           c, v, contributing = 0, search = 0, scanbeam= 0, sbt_entries= 0;
  int           vclass = 0, bl = 0, br = 0, tl = 0, tr = 0;
  double        *sbt= NULL, xb = 0, px = 0, yb = 0,
                            yt = 0, dy = 0, ix = 0, iy = 0;
                       ...
                       gpc_tristrip *result)
{
  ...
  vertex_type   cft = NUL;
  int           in[2], exists[2], parity[2]= {LEFT, LEFT};
  int           s = 0, v = 0, contributing = 0,
                search = 0, scanbeam= 0, sbt_entries= 0;
  int           vclass = 0, bl = 0, br = 0, tl = 0, tr = 0;
  double        *sbt= NULL, xb = 0.0, px = 0.0, nx = 0.0, yb = 0.0,
                            yt = 0.0, dy = 0.0, ix = 0.0, iy = 0.0;
