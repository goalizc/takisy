# ifndef PREPROCESSOR_LIST_FOLD_LEFT_HPP
# define PREPROCESSOR_LIST_FOLD_LEFT_HPP
#
...
# endif
#
# define PP_LIST_FOLD_LEFT PP_CAT(PP_LIST_FOLD_LEFT_, PP_AUTO_REC(PP_WHILE_P, 256))
#
# define PP_LIST_FOLD_LEFT_257(o, s, l) PP_ERROR(0x0004)
#
# define PP_LIST_FOLD_LEFT_D(d, o, s, l) PP_LIST_FOLD_LEFT_ ## d(o, s, l)
# define PP_LIST_FOLD_LEFT_2ND PP_LIST_FOLD_LEFT
# define PP_LIST_FOLD_LEFT_2ND_D PP_LIST_FOLD_LEFT_D
#
# if PP_CONFIG_FLAGS() & PP_CONFIG_EDG()
#    include <takisy/preprocessor/list/detail/edg/fold_left.hpp>
# elif PP_CONFIG_FLAGS() & PP_CONFIG_DMC()
#    include <takisy/preprocessor/list/detail/dmc/fold_left.hpp>
# else
#    include <takisy/preprocessor/list/detail/fold_left.hpp>
# endif
#
