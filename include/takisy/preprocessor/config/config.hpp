...
# /* PP_VARIADICS */
#
# define PP_VARIADICS_MSVC 0
# if !defined PP_VARIADICS
...
#        define PP_VARIADICS 0
#    /* VC++ (C/C++) */
#    elif defined _MSC_VER && _MSC_VER >= 1400 && (!defined __EDG__ || defined(__INTELLISENSE__)) && !defined __clang__
#        define PP_VARIADICS 1
#        undef PP_VARIADICS_MSVC
#        define PP_VARIADICS_MSVC 1
#    /* Wave (C/C++), GCC (C++) */
