# ifndef PREPROCESSOR_CONTROL_WHILE_HPP
# define PREPROCESSOR_CONTROL_WHILE_HPP
#
...
#    define PP_WHILE_P(n) PP_BITAND(PP_CAT(PP_WHILE_CHECK_, PP_WHILE_ ## n(PP_WHILE_F, PP_NIL, PP_NIL)), PP_BITAND(PP_CAT(PP_LIST_FOLD_LEFT_CHECK_, PP_LIST_FOLD_LEFT_ ## n(PP_NIL, PP_NIL, PP_NIL)), PP_CAT(PP_LIST_FOLD_RIGHT_CHECK_, PP_LIST_FOLD_RIGHT_ ## n(PP_NIL, PP_NIL, PP_NIL))))
# else
...
#
# if PP_CONFIG_FLAGS() & PP_CONFIG_EDG()
#    include <takisy/preprocessor/control/detail/edg/while.hpp>
# elif PP_CONFIG_FLAGS() & PP_CONFIG_MSVC()
#    include <takisy/preprocessor/control/detail/msvc/while.hpp>
# elif PP_CONFIG_FLAGS() & PP_CONFIG_DMC()
#    include <takisy/preprocessor/control/detail/dmc/while.hpp>
# else
#    include <takisy/preprocessor/control/detail/while.hpp>
# endif
#
