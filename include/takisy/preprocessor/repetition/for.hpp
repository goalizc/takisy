# ifndef PREPROCESSOR_REPETITION_FOR_HPP
# define PREPROCESSOR_REPETITION_FOR_HPP
#
...
# endif
#
# define PP_FOR PP_CAT(PP_FOR_, PP_AUTO_REC(PP_FOR_P, 256))
#
...
#    include <takisy/preprocessor/repetition/detail/edg/for.hpp>
# elif PP_CONFIG_FLAGS() & PP_CONFIG_MSVC()
#    include <takisy/preprocessor/repetition/detail/msvc/for.hpp>
# elif PP_CONFIG_FLAGS() & PP_CONFIG_DMC()
#    include <takisy/preprocessor/repetition/detail/dmc/for.hpp>
# else
#    include <takisy/preprocessor/repetition/detail/for.hpp>
# endif
#
# if PP_CONFIG_FLAGS() & PP_CONFIG_DMC()
# define PP_FOR_257_PR(s, p) PP_BOOL(p##(257, s))
# else
# define PP_FOR_257_PR(s, p) PP_BOOL(p(257, s))
# endif

# define PP_FOR_257_ERROR() PP_ERROR(0x0002)
# define PP_FOR_257(s, p, o, m) \
	PP_IIF \
		( \
		PP_FOR_257_PR(s,p), \
		PP_FOR_257_ERROR, \
