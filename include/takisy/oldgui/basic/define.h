#ifndef define_h_inclued_20130712
#define define_h_inclued_20130712
...
enum VirtualKey
{
    ...
    vkBrowserForward = 0xA7, vkBrowserRefresh    = 0xA8, vkBrowserStop = 0xA9,
    vkBrowserSearch  = 0xAA, vkBrowserFavorites  = 0xAB, vkBrowserHome = 0xAC,
    ...
    vkOem7           = 0xDE, vkOem8              = 0xDF, vkOem102      = 0xE2,
    vkProcesskey     = 0xE5, vkPacket            = 0xE7, vkAttn        = 0xF6,
    vkCrsel          = 0xF7, vkExsel             = 0xF8, vkEreof       = 0xF9,
    vkPlay           = 0xFA, vkZoom              = 0xFB, vkNoname      = 0xFC,
    vkPa1            = 0xFD, vkLaunchMediaSelect = 0xB5,
};
...
#endif //define_h_inclued_20130712
